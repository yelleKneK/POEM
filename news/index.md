...
- The broom generics
  ...
  [`library(POEM)`](https://github.com/yelleKneK/POEM) alone;
  [`glance()`](https://yelleknek.github.io/POEM/reference/poem_broom.md)
  ...
  returns a `poem_tbl`, and the p-value columns of every wide table
...
- [`?pe_mediation`](https://yelleknek.github.io/POEM/reference/pe_mediation.md)
  and the guided tour state when POEM is the right tool and when it is
